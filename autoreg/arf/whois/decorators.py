...
def check_blackout():
    return os.path.exists("/tmp/blackout")
...
def login_active_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url=None):
    ...
    This allows for immediate account blocking, or site blackout.
    """
    actual_decorator = user_passes_test(
        lambda u: u.is_authenticated and u.is_active and not check_blackout(),
        login_url=login_url,
...
def blackout(function):
    """
    Decorator for site blackout.
    """
